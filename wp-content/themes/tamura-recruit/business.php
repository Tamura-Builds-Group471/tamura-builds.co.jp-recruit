<?php
/*
Template Name: 事業を知る（子テーマ）_カスタムテンプレート
*/
?>
...
<?php get_template_part('sections/sec_job_connection'); ?>

<?php get_template_part('sections/sec_people_connection', null, [
    'ttl'     => 'この事業に関わる人',
]) ?>

<?php get_template_part('sections/sec_application_connection', null, [
    'ttl'     => 'この事業に関わる採用情報',
]) ?>

<?php get_template_part('sections/sec_business_archive'); ?>
