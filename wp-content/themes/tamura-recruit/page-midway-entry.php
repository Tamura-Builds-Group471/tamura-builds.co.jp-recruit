...
<section id="entry" class="pt_50 pb_50">
    <div class="sec_inner">
        <p class="text tx_center mx_auto" style="max-width:570px;">中途採用専用のエントリーページです。<br>（<a class="theme_blue tx_deco_under" href="<?php echo home_url(); ?>/new-graduates-entry">新卒採用エントリーページはこちら</a>）<br>LINEまたはフォームよりエントリーいただけます。なお当社では、通常のエントリーに加え、見学や仕事体験ができる大人のインターンへのご参加も可能です。<br>お気軽にご連絡ください。</p>
