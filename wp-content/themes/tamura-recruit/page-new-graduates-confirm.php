<?php
/**
 * page-new-graduates-confirm.php
 */
get_header(); ?>
...
<section id="entry" class="pt_50 pb_50">
    <div class="sec_inner">
        <!-- <p class="text tx_center">新卒採用専用のエントリーページです。<br>（<a class="theme_blue tx_deco_under" href="<?php echo home_url(); ?>/midway-entry">中途採用エントリーページはこちら</a>）<br>LINEまたはフォームよりエントリーいただけます。</p>
