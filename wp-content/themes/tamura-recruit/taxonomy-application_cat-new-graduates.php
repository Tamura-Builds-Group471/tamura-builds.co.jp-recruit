...
<section id="pplication_new-graduates_intro" class="pt_50 pb_50">
    <div class="sec_inner">
        <div class="mx_auto" style="max-width:570px;">
            <p class="text">新卒採用の募集職種一覧になります。要項をご確認の上、<a href="<?php echo home_url(); ?>/new-graduates-entry" class="theme_blue tx_deco_under">エントリー</a>へお進みください。中途採用の方は<a href="<?php echo home_url(); ?>/application/midway" class="theme_blue tx_deco_under">中途採用 募集職種</a>をご確認ください。</p>
        </div>
    </div>
</section>
